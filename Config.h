...
static const char* FIRMWARE_VERSION = "2.1.0-deviceHeaterFan";
...
// -----------------------------------------------------------------------------
// Local control panel: ESP32 hosts its own AP + web server, so the device can
// be controlled from a phone/laptop without going through the Pi/MQTT at all.
// Runs alongside the WIFI_SSID station connection above (AP+STA mode).
// -----------------------------------------------------------------------------
